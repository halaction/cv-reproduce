...
The tracked runs were executed in a lightweight development environment and logged through Weights \& Biases. Some intermediate debugging runs were performed on CPU in Colab-like settings during development. Because the currently compared runs may not be perfectly matched in epoch budget or runtime environment, the main comparison should be treated as informative rather than as a fully controlled benchmark.
